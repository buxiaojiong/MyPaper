...
@implementation BXJMyAddressView
    ...
    if (self) {
        ...
        topBackBtnView.BackNacAction = ^(){
            ...
            [UIView  animateWithDuration:0.3 animations:^{
                ...
                if (_saveAddressAction) {
                    _saveAddressAction(nil , NO);
                }
        ...
        self.placeholderLabel.text = @"请输入详细地址";
...
{
    if (_saveAddressAction) {
        _saveAddressAction(self.textView.text,NO);
